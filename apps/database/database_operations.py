...
class DatabaseOperation: ##Class to handle database operations
    def __init__(self, run_id, data_path, mode) -> None:
        self.run_id = run_id
        self.dat_path = data_path
    ...
    def database_connection(self, database_name):
        try:
            ...
            self.logger.info("Opened %s database succefully" % database_name)
    ...
    def create_table(self, database_name, table_name,column_names):
        ...
        try:
            ...
            if (database_name=='prediction'):
                conn.execute("Drop table if exist '"+ table_name,"';")
